...
Because why should we play fair with others in the sandbox when we could have it all for ourselves?
<br/>
### Shared rail infrastructure 
As mentioned before, Amtrak suffers from significant delays due to freight operators dispatching their trains. However, the root of this problem
is not *just* that freight operators disregard passenger service, but moreso that (with exception to the Northeast Corridor, and Brightline in Florida) 
there is generally no dedicated heavy rail infrastructure in the United States dedicated to passenger service. Most passenger heavy rail service piggy-backs off of the existing freight rail
infrastructure, and 
<br/>
